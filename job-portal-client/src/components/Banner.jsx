        ...
        <form>
            <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                ...
                focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
                    ...
                    py-1,5 pl-8 text-gray-900 placeholder::text-gary-400 focus:right-0 sm:text-sm sm:leading-6' 
                    onChange={handleInputChange}
                    value={query}
                    />

                    <FiSearch className='absolute mt-1 ml-2 text-gray-400'/>
                </div>
                ...
                focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full'>
                    <input type='text' name='location' id='location' placeholder='Location' className='block flex-1 border-0 bg-transparent 
                    py-1,5 pl-8 text-gray-900 placeholder::text-gary-400 focus:right-0 sm:text-sm sm:leading-6' 
                    onChange={handleInputChange}
                    
                    />

                    <FiMapPin className='absolute mt-1 ml-2 text-gray-400'/>
                </div>
